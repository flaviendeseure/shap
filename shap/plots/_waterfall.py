...
def waterfall(shap_values, abs_order=True, reverse=True, max_display=10, show=True):
    ...
    By default, features are sorted by the magnitude of their SHAP values with the smallest
    ...
    abs_order: bool
        Whether to sort the features by the absolute value of their SHAP values
        If False, the features will be sorted based on their SHAP values without taking the absolute value into account.
    
    reverse: bool
        Whether to reverse the sorting order of the features.
